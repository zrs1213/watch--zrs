...
static const font_chinese_t g_font_parse[] = {
    {
        .name = "成",
        .model = (const uint8_t[]) {
0x00,0x00,0x00,0x00,0x00,0xD8,0x00,0xC8,0x1F,0xFC,0x10,0xC0,0x1E,0x48,0x1F,0x58,
0x13,0x50,0x13,0x70,0x36,0x64,0x31,0xF4,0x21,0x1C,0x00,0x00,0x00,0x00,0x00,0x00,
            /*"成",0*/
        },
    },
    {
        .name = "都",
        .model = (const uint8_t[]) {
0x00,0x00,0x00,0x00,0x0D,0x08,0x3F,0xFC,0x0D,0x6C,0x3F,0x68,0x3F,0xF8,0x1F,0x68,
0x3F,0x6C,0x1F,0x64,0x11,0x7C,0x1F,0x68,0x11,0x60,0x00,0x00,0x00,0x00,0x00,0x00,
            /*"都",1*/
        },
    },
    {
        .name = "毕",
        .model = (const uint8_t[]) {
0x00,0x00,0x00,0x00,0x18,0xC0,0x1E,0xD8,0x1F,0xE0,0x18,0xC4,0x1F,0xFC,0x18,0x78,
0x01,0x80,0x3F,0xFC,0x01,0x80,0x01,0x80,0x01,0x80,0x00,0x00,0x00,0x00,0x00,0x00,
            /*"毕",2*/
        },
    },
    {
        .name = "节",
        .model = (const uint8_t[]) {
0x00,0x00,0x00,0x00,0x04,0x20,0x3F,0xFC,0x04,0x20,0x04,0x20,0x1F,0xF8,0x02,0x18,
0x02,0x18,0x02,0x18,0x02,0x78,0x02,0x20,0x02,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
            /*"节",3*/
        },
    },
    {
        .name = "星",
        .model = (const uint8_t[]) {
0x00,0x00,0x00,0x00,0x0F,0xF0,0x18,0x18,0x1F,0xF8,0x18,0x18,0x0F,0xF0,0x09,0x80,
0x1F,0xF8,0x31,0x80,0x0F,0xF0,0x01,0x80,0x3F,0xFC,0x00,0x00,0x00,0x00,0x00,0x00,
            /*"星",4*/
        },
    },
    {
        .name = "期",
        .model = (const uint8_t[]) {
0x00,0x00,0x00,0x00,0x12,0x78,0x3F,0x7C,0x12,0x4C,0x1E,0x7C,0x12,0x4C,0x1E,0x4C,
0x12,0x7C,0x3F,0x4C,0x12,0x4C,0x1B,0xCC,0x20,0x9C,0x00,0x00,0x00,0x00,0x00,0x00,
            /*"期",5*/
        },
    },
    {
        .name = "未",
        .model = (const uint8_t[]) {
0x00,0x00,0x00,0x00,0x01,0x80,0x01,0x80,0x1F,0xF8,0x01,0x80,0x01,0x80,0x3F,0xFC,
0x03,0xC0,0x07,0xE0,0x1D,0xB8,0x31,0x8C,0x01,0x80,0x00,0x00,0x00,0x00,0x00,0x00,
            /*"未",6*/
        },
    },
    {
        .name = "知",
        .model = (const uint8_t[]) {
0x00,0x00,0x00,0x00,0x10,0x00,0x1E,0x7C,0x3F,0x4C,0x2C,0x4C,0x0C,0x4C,0x3F,0x4C,
0x0C,0x4C,0x0E,0x4C,0x1B,0x4C,0x31,0x7C,0x20,0x48,0x00,0x00,0x00,0x00,0x00,0x00,
            /*"知",7*/
        },
    },
    {
        .name = "室",
        .model = (const uint8_t[]) {
0x00,0x00,0x00,0x00,0x01,0x80,0x3F,0xFC,0x30,0x0C,0x0F,0xF0,0x06,0x20,0x0F,0xF8,
0x01,0x80,0x1F,0xF8,0x01,0x80,0x01,0x80,0x3F,0xFC,0x00,0x00,0x00,0x00,0x00,0x00,
            /*"室",8*/
        },
    },
    {
        .name = "内",
        .model = (const uint8_t[]) {
0x00,0x00,0x00,0x00,0x01,0x80,0x01,0x80,0x1F,0xFC,0x11,0x88,0x11,0x88,0x11,0xC8,
0x13,0x68,0x16,0x38,0x10,0x08,0x10,0x08,0x10,0x38,0x00,0x00,0x00,0x00,0x00,0x00,
            /*"内",9*/
        },
    },
    {
        .name = "环",
        .model = (const uint8_t[]) {
0x00,0x00,0x00,0x00,0x00,0x00,0x3D,0xFC,0x18,0x60,0x18,0x60,0x3C,0xF0,0x19,0xF8,
0x1B,0x6C,0x18,0x60,0x3C,0x60,0x20,0x60,0x00,0x60,0x00,0x00,0x00,0x00,0x00,0x00,
            /*"环",10*/
        },
    },
    {
        .name = "境",
        .model = (const uint8_t[]) {
0x00,0x00,0x00,0x00,0x18,0x60,0x19,0xF8,0x18,0x90,0x3F,0xFC,0x19,0xF8,0x19,0x08,
0x19,0xF8,0x1D,0xF8,0x38,0xB0,0x01,0xB4,0x03,0x1C,0x00,0x00,0x00,0x00,0x00,0x00,
            /*"境",11*/
        },
    },
    {
...
0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    ...
    },
    {
        .name = "二",
        .model = (const uint8_t[]) {
0x00,0x00,0x00,0x00,0x00,0x00,0x0F,0xF0,0x1F,0xF8,0x00,0x00,0x00,0x00,0x00,0x00,
0x00,0x00,0x00,0x00,0x1F,0xF8,0x3F,0xFC,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
            /*"二",13*/
        },
    },
    {
        .name = "三",
        .model = (const uint8_t[]) {
0x00,0x00,0x00,0x00,0x00,0x00,0x1F,0xF8,0x00,0x00,0x00,0x00,0x00,0x00,0x0F,0xF0,
0x00,0x00,0x00,0x00,0x00,0x00,0x3F,0xFC,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
    ...
    },
    {
        .name = "四",
        .model = (const uint8_t[]) {
0x00,0x00,0x00,0x00,0x00,0x00,0x3F,0xFC,0x32,0x4C,0x32,0x4C,0x32,0x4C,0x36,0x4C,
0x3C,0x7C,0x38,0x0C,0x30,0x0C,0x3F,0xFC,0x10,0x08,0x00,0x00,0x00,0x00,0x00,0x00,
            /*"四",15*/
        },
    },
    {
        .name = "五",
        .model = (const uint8_t[]) {
0x00,0x00,0x00,0x00,0x00,0x00,0x1F,0xF8,0x03,0x00,0x03,0x00,0x0F,0xE0,0x0F,0xF0,
0x02,0x30,0x02,0x30,0x06,0x20,0x3F,0xFC,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
            /*"五",16*/
        },
    },
    {
        .name = "六",
        .model = (const uint8_t[]) {
0x00,0x00,0x00,0x00,0x01,0x00,0x01,0x80,0x00,0x80,0x3F,0xFC,0x00,0x00,0x00,0x40,
0x06,0x60,0x0C,0x30,0x18,0x18,0x38,0x0C,0x10,0x08,0x00,0x00,0x00,0x00,0x00,0x00,
            /*"六",17*/
        },
    },
    {
        .name = "日",
        .model = (const uint8_t[]) {
0x00,0x00,0x00,0x00,0x00,0x00,0x1F,0xF8,0x18,0x18,0x18,0x18,0x18,0x18,0x1F,0xF8,
0x18,0x18,0x18,0x18,0x18,0x18,0x1F,0xF8,0x08,0x18,0x00,0x00,0x00,0x00,0x00,0x00,
            /*"日",18*/
        },
    },
    {
        .name = "密",
        .model = (const uint8_t[]) {
0x00,0x00,0x00,0x00,0x01,0x80,0x3F,0xFC,0x33,0x2C,0x15,0xE0,0x1F,0xD8,0x37,0x34,
0x3F,0xE0,0x01,0x90,0x19,0x98,0x1F,0xF8,0x0F,0xF8,0x00,0x00,0x00,0x00,0x00,0x00,
            /*"密",19*/
        },
    },
    {
        .name = "码",
        .model = (const uint8_t[]) {
0x00,0x00,0x00,0x00,0x3C,0xF0,0x3F,0xF8,0x18,0x98,0x10,0x98,0x3C,0x98,0x35,0xFC,
0x34,0x0C,0x15,0xEC,0x1D,0xFC,0x1C,0x08,0x00,0x38,0x00,0x00,0x00,0x00,0x00,0x00,
            /*"码",20*/
        },
    },
};
